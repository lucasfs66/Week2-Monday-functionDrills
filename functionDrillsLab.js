...
function calculator(gold) {
 return gold / 3
}
let totalFrogs = calculator(27)
...
//CODE HERE
function calculator2(gold) {
  return Math.round(gold / 3)
 }
 let totalFrogs2 = calculator2(4)
...
/*
  ...
  false if it is not. Create a variable, `arrayIsAscending` and set it equal to your function invoked. 
